...
export class Search extends Component{
    ...
    componentDidMount = ()=>{
        const SearchTitle = this.props.match.params.id;
        this.state.searchTitle = SearchTitle;
    }
    render(){
        return <div>
            <SearchNav search={this.props.match.params.id} />
                ...
                <div className="page-div search-div row justif-content-center">
                    ...
                    <div className="page-right col-10 col-xl-7 row">
                        <div className="catlogy-div catlogy-1">
                            <span className="catlogy">{this.props.match.params.id}</span>
